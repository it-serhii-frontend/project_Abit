...
import test.test.security.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers("/resources/**", "/addStudent", "/allStudents", "/listStudents",
				"/Student/{id}/remove", "/Student/{id}/edit", "/Student/{id}/marks");
	}
